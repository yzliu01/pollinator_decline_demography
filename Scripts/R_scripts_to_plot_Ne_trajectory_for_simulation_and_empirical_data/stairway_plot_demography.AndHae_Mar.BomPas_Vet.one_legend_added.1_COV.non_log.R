...
# single plot old
    ...
    scale_y_log10(limits = c(100,800000),
                        ...
                        #breaks = seq(0, 800000, by = 100000),  # Major ticks
                        #minor_breaks = seq(0, 800000, by = 10000),  # Minor ticks every 50000 between 100000 and 200000
                        #breaks = seq(0, 800000, by = 50000), 
                        #breaks = c(1, 10, 100, 1000, 10000, 100000, 800000),  # Define specific break points for y-axis
